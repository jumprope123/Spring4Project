    ...
    <form id="newgalfrm">
        <div class="row margin1050">
            ...
            <div class="col-6 text-right">
                <a href="/galley/list"><button type="button" id="listgalbtn" class="btn btn-light">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <button type="button" id="newgalbtn" class="btn btn-primary"><i class="bi bi-check"></i>입력완료</button>
